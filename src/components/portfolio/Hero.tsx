...
export function Hero() {
  ...
  const yAvatar = useTransform(scrollYProgress, [0, 1], [0, 80]);
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-10 px-6 lg:grid-cols-12">
        ...
        >
          ...
          >
            ...
            {/* Conic ring */}
            <div className="absolute inset-6 rounded-full bg-[conic-gradient(from_180deg,transparent,oklch(0.78_0.13_195/0.4),transparent)] opacity-60 blur-xl animate-spin-slow" />
            {/* Hairline ring */}
